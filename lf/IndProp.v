...
Proof.
  ...
  { intros E. induction E as [| |n' m' En' IHEn' Em' IHEm'].
    ...
    - apply ev_sum. exact IHEn'. exact IHEm'. }
  { intros E. induction E as [|n' En' IHEn'].
    - exact ev'_0.
    - assert (H : forall n, S n = n + 1) by lia. rewrite -> 2 H.
      rewrite <- add_assoc. simpl. apply ev'_sum.
      + exact IHEn'.
      + exact ev'_2. }
Qed.
(** [] *)
...
Proof.
  ...
  induction En as [|n' En' IHEn'].
  - intros Enm. simpl in Enm. exact Enm.
  - intros Enm. apply IHEn'.
    Search "plus_Sn_m".
    rewrite -> plus_Sn_m in Enm. simpl in Enm.
    inversion Enm as [|? Enm']. exact Enm'.
Qed.
(** [] *)
...
Proof.
  ...
  { apply ev_sum. exact E1. exact E2. }
  assert (H2 : n + m + (n + p) = n + n + (m + p)) by lia. rewrite -> H2 in H1. clear H2.
  apply (ev_ev__ev (n + n) (m + p)) in H1.
  - exact H1.
  - Check ev_double. pose proof (L1 := ev_double n).
    Check double_plus. pose proof (L2 := double_plus n).
    rewrite -> L2 in L1. exact L1. 
Qed.
(** [] *)
...
Proof.
  ...
  (*
   ...
   Think of E2 as predicate P on o.
   Think of goal as predicate Q on o.
   We aim to show by induction forall n, P n -> Q n.
   *)
  induction E2 as [|m' E2' IHE2'].
  - exact E1.
  - apply le_S. exact IHE2'.
Qed.
...
Theorem n_le_m__Sn_le_Sm : forall n m,
  n <= m -> S n <= S m.
Proof.
  intros n m E. induction E as [|m' E' IHE'].
  - apply le_n.
  - apply le_S. exact IHE'.
Qed.

Theorem Sn_le_Sm__n_le_m : forall n m,
  S n <= S m -> n <= m.
Proof.
  intros n m E. inversion E.
  - exact (le_n m).
  - apply le_trans with (n := (S n)).
    + apply le_S. exact (le_n n).
    + exact H0.
Qed.
...
Proof.
  ...
  - intros m. destruct m.
    ...
    + destruct (IHn' m) as [H | H].
      ...
      * right. apply n_le_m__Sn_le_Sm. exact H.
Qed.
...
Proof.
  ...
  - assert (H : S (a + b') = a + S b') by lia. rewrite <- H. apply le_S. exact IHb'.
Qed.
...
Proof.
  ...
  induction n as [|n' IHn'].
  - simpl. intros p H. left. apply O_le_n.
  - simpl. intros p H. destruct p as [|p'].
    + right. rewrite <- plus_Sn_m in H. apply plus_le in H. destruct H as [H1 H2].
      simpl in H2. exact H2.
    + rewrite -> plus_Sn_m in H. apply Sn_le_Sm__n_le_m in H. apply (IHn' p') in H. destruct H.
      * left. apply n_le_m__Sn_le_Sm. exact H.
      * right. exact H. 
Qed.
...
Theorem plus_le_compat_l : forall n m p,
  ...
  p + n <= p + m.
Proof.
  intros n m p E. induction p as [|p' IHp'].
  - simpl. exact E.
...
Proof.
  ...
  - assert (H1 : forall n m, n + S m = S (n + m)) by lia.
    rewrite -> ? H1. apply n_le_m__Sn_le_Sm. exact IHp'.
Qed.
...
Proof.
  intros n m p H.
  pose proof (H1 := le_plus_l m p).
  apply (le_trans n m (m + p) H H1).
Qed.
...
Theorem n_lt_m__n_le_m : forall n m,
  ...
  n <= m.
Proof.
  intros n m H. unfold "<" in *.
  apply Sn_le_Sm__n_le_m. apply le_S. exact H.
Qed.
...
Proof.
  ...
  unfold "<" in *.
  split.
  - rewrite <- plus_Sn_m in H. apply plus_le in H. destruct H as [H1 _]. exact H1.
  - rewrite <- add_comm in H. rewrite <- plus_Sn_m in H. apply plus_le in H. destruct H as [H1 _]. exact H1.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m H. destruct m as [|m'].
    ...
    + simpl in H. apply n_le_m__Sn_le_Sm. apply IHn'. exact H.
Qed.
...
Proof.
  ...
  - intros n H. destruct n as [|n'].
    + simpl. reflexivity.
    + simpl. apply IHm'. apply Sn_le_Sm__n_le_m. exact H.
Qed.
...
(** - Which of the following propositions are provable?
    ...
    R 1 1 2 <- R 0 1 1 <- R 0 0 0

    - If we dropped constructor [c5] from the definition of [R],
      would the set of provable propositions change?  Briefly (1
      sentence) explain your answer.

    No, since c1-c4 are symmetric in terms of arguments m and n.

    - If we dropped constructor [c4] from the definition of [R],
      would the set of provable propositions change?  Briefly (1
      sentence) explain your answer.
    
    No, since c4 only reverses the constructors c2 and c3 combined.
...
Proof.
  ...
  - intros H. induction H.
    ...
    + rewrite <- plus_n_Sm. f_equal. exact IHR.
    + injection IHR as IHR. rewrite <- plus_n_Sm in IHR. injection IHR as IHR. exact IHR.
    + rewrite <- add_comm. exact IHR.
  - generalize dependent o.
    induction m as [|m' IHm'].
    + induction n as [|n' IHn'].
      * intros o H. simpl in H. rewrite <- H. apply c1.
      * intros o H. simpl in H. rewrite <- H. apply c3. apply IHn'. simpl. reflexivity.
    + induction n as [|n' IHn'].
      * intros o H. rewrite <- plus_n_O in H. rewrite <- H. apply c2. apply IHm'. rewrite <- plus_n_O. reflexivity.
      * intros o H. rewrite <- plus_n_Sm in H. rewrite <- H. apply c2. apply IHm'. rewrite <- plus_n_Sm. reflexivity.
Qed.
(** [] *)
...
(* Without c2, l1 can only be at the head of l2 *)
...
Proof.
  ...
  induction H.
  - apply c1.
  - simpl. apply c2. exact IHsubseq.
  - simpl. apply c3. exact IHsubseq.
Qed.
...
Proof.
  ...
  Check subseq_ind.
  induction H2 as [l2'|n' l2' l3' H2' IH|n' l2' l3' H2' IH].
  - intros l1 H1. inversion H1. apply c1.
  - intros l1 H1. apply c2. apply IH. exact H1.
  - intros l1 H1. inversion H1.
    + apply c1.
    + apply c2. apply IH. exact H2.
    + apply c3. apply IH. exact H2.
Qed.
(** [] *)
...
(*
R says list l contains at least n elements.
Therefore only R 2 [1;0] and R 1 [1;2;1;0] are provable.
    [] *)
...
Proof.
  ...
  - simpl. apply MStarApp.
    ...
    + apply IHss'. intros s' H'. apply H. simpl. right. exact H'.
Qed.
(** [] *)
...
Proof.
  intros T re. split.
  { intros H. destruct H as [s H].
    induction H as [|x|s1 re1 s2 re2 H1 IH1 H2 IH2
                    |s1 re1 re2 H1 IH1|re1 s2 re2 H2 IH2|re|s1 s2 re H1 IH1 H2 IH2].
    - simpl. reflexivity.
    - simpl. reflexivity.
    - simpl. rewrite -> IH1, IH2. simpl. reflexivity.
    - simpl. rewrite -> IH1. simpl. reflexivity.
    - simpl. rewrite -> IH2.
      assert (orb_sym : forall a b, a || b = b || a).
      { intros a b. destruct a, b; repeat reflexivity. }
       rewrite -> orb_sym. simpl. reflexivity.
    - simpl. reflexivity.
    - simpl. reflexivity. }
  { intros H. induction re as [| |x|re1 IH1 re2 IH2|re1 IH1 re2 IH2|re IH].
    - simpl in H. discriminate H.
    - exists []. apply MEmpty.
    - exists [x]. apply MChar.
    - simpl in H.
      assert (andb_true : forall a b, a && b = true -> a = true /\ b = true).
      { intros a b H'. destruct a, b; split; repeat reflexivity; try discriminate. }
      apply andb_true in H. destruct H as [H1 H2].
      apply IH1 in H1. apply IH2 in H2.
      destruct H1 as [s1 H1]. destruct H2 as [s2 H2].
      exists (s1 ++ s2). apply MApp; exact H1 || exact H2.
    - simpl in H.
      assert (orb_true : forall a b, a || b = true -> a = true \/ b = true).
      { intros a b H'. destruct a, b.
        - left. reflexivity.
        - left. reflexivity.
        - right. reflexivity.
        - discriminate H'. }
      apply orb_true in H. destruct H as [H|H].
      + apply IH1 in H. destruct H as [s H1]. exists s. apply MUnionL. exact H1.
      + apply IH2 in H. destruct H as [s H2]. exists s. apply MUnionR. exact H2.
    - exists []. apply MStar0. }
Qed.
(** [] *)
...
Proof.
  ...
  - injection Heqre' as Heqre'. rewrite -> Heqre' in *. clear Heqre'.
    destruct IH2 as [ss [H1 H2]].
    + reflexivity.
    + rewrite -> H1. exists (s1 :: ss). simpl. split.
      * reflexivity.
      * intros s' H. destruct H.
        { rewrite <- H. exact Hmatch1. }
        { apply H2. exact H. }
Qed.
(** [] *)
...
Proof.
  ...
  - (* MChar *)
    simpl. intros H. inversion H as [|n1 H1 Heq]. inversion H1.
  - (* MApp *)
    simpl. intros H. rewrite -> app_length in H. apply add_le_cases in H.
    destruct H as [H|H].
    { apply IH1 in H. clear IH1 IH2. destruct H as [s1' [s2' [s3' H]]].
      exists s1', s2', (s3' ++ s2). destruct H as [H1 H2]. split.
      - rewrite -> 2 app_assoc. f_equal. rewrite <- app_assoc. exact H1.
      - destruct H2 as [H2' H2'']. split.
        + exact H2'.
        + intros m. rewrite -> 2 app_assoc. apply MApp. 
          * rewrite <- app_assoc. apply H2''.
          * exact Hmatch2. }
    { apply IH2 in H. clear IH1 IH2. destruct H as [s1' [s2' [s3' H]]].
      exists (s1 ++ s1'), s2', s3'. destruct H as [H1 H2]. split.
      - rewrite <- app_assoc. f_equal. exact H1.
      - destruct H2 as [H2' H2'']. split.
        + exact H2'.
  ...
  - (* MUnionL *)
    ...
    apply IH in H1. clear IH. destruct H1 as [s2' [s3' [s4' H1]]].
    exists s2', s3', s4'. destruct H1 as [H1' [H1'' H1''']]. split.
    + exact H1'.
    + split.
      * exact H1''.
      * intros m. apply MUnionL. apply H1'''.
  - (* MUnionR *)
    simpl. intros H. apply plus_le in H. destruct H as [_ H2]. 
    apply IH in H2. clear IH. destruct H2 as [s2' [s3' [s4' H2]]].
    exists s2', s3', s4'. destruct H2 as [H2' [H2'' H2''']]. split.
    + exact H2'.
    + split.
      * exact H2''.
      * intros m. apply MUnionR. apply H2'''.
  - (* MStar0 *)
    simpl. intros H. inversion H as [H1|]. apply pumping_constant_0_false in H1. destruct H1.
  - (* MStarApp *)
    simpl in *. intros H. admit.
Admitted.
(** [] *)
...
Proof.
  intros P b H. inversion H as [H'|H'].
  - split.
...
Proof.
  ...
  - simpl. intros H. simpl in Hcount. destruct (eqbP n m) as [H'|H'].
    + simpl in Hcount. discriminate Hcount.
    + simpl in Hcount. apply IHl' in Hcount. destruct H.
      * apply H'. symmetry. exact H.
...
Inductive nostutter {X:Type} : list X -> Prop :=
  | SEmpty : nostutter []
  | SSingle (x : X) : nostutter [x]
  | SAppend (h1 h2 : X) (t : list X) (Hneq : h1 <> h2) : nostutter (h2 :: t) -> nostutter (h1 :: h2 :: t).
...
Inductive merge {X:Type} : list X -> list X -> list X -> Prop :=
  | LEmpty : merge [] [] []
  | LLeft (h : X) (l1 l2 l : list X) : merge l1 l2 l -> merge (h :: l1) l2 (h :: l)
  | LRight (h : X) (l1 l2 l : list X) : merge l1 l2 l -> merge l1 (h :: l2) (h :: l).
...
Theorem merge_filter : forall (X : Set) (test: X->bool) (l l1 l2 : list X),
  ...
  filter test l = l1.
Proof.
  intros X test l l1 l2 P.
  induction P as [|h l1 l2 l H IH|h l1 l2 l H IH].
  - intros _ _. simpl. reflexivity.
  - intros H1 H2. simpl. destruct (test h) eqn:T.
    + f_equal. apply IH.
      * simpl in H1. destruct H1 as [_ H1]. exact H1.
      * exact H2.
    + simpl in H1. destruct H1 as [H1 _]. rewrite -> H1 in T. discriminate T.
  - intros H1 H2. simpl. destruct (test h) eqn:T.
    + simpl in H2. destruct H2 as [H2 _]. rewrite -> H2 in T. discriminate T.
    + simpl in H2. destruct H2 as [_ H2]. apply (IH H1 H2).
Qed.
...
Proof.
  ...
  - intros H. apply app_exists in H.
    ...
    + simpl in H. destruct H as [H1 [H2 H3]].
      subst. left. split. exact H2. exact H3.
    + simpl in H. destruct H as [H1 [H2 H3]].
      injection H1 as H1 H1'. subst. right.
      exists s0', s1. split. reflexivity. split. exact H2. exact H3.
  - intros [H | H].
    + destruct H as [H1 H2].
      Print MApp. pose proof (MApp [] re0 (a :: s) re1 H1 H2) as H'.
      simpl in H'. exact H'.
    + destruct H as [s0 [s1 [H1 [H2 H3]]]].
      rewrite -> H1. pose proof (MApp (a :: s0) re0 s1 re1 H2 H3) as H'.
      simpl in H'. exact H'.
Qed.
(** [] *)
...
Proof.
  intros a s re. split.
  - intros H.
    remember (a :: s) as l eqn:Heql.
    remember (Star re) as sre eqn:Heqsre.
    induction H.
    + discriminate Heqsre.
    + discriminate Heqsre.
    + discriminate Heqsre.
    + discriminate Heqsre.
    + discriminate Heqsre.
    + inversion Heqsre. clear Heqsre. subst. inversion Heql.
    + inversion Heqsre. clear Heqsre. subst.
      destruct s1 as [|a' s1'].
      * simpl in Heql. apply IHexp_match2.
        { exact Heql. }
        { reflexivity. }
      * simpl in Heql. injection Heql as Heql Heql'. subst.
        exists s1', s2. split. reflexivity. split. exact H. exact H0.
  - intros [s0 [s1 [H1 [H2 H3]]]].
    subst. assert (H : (a :: s0) ++ s1 = a :: (s0 ++ s1)). { reflexivity. }
    rewrite <- H. apply MStarApp. exact H2. exact H3.
Qed.
(** [] *)
...
Proof.
  ...
  intros re. destruct (match_eps re) eqn:E.
  - apply ReflectT. induction re.
    + simpl in E. discriminate E.
    + simpl in E. apply MEmpty.
    + simpl in E. discriminate E.
    + simpl in E. apply andb_true_iff in E. destruct E as [E1 E2].
      apply IHre1 in E1. apply IHre2 in E2. apply (MApp [] re1 [] re2). exact E1. exact E2.
    + simpl in E. apply orb_true_iff in E. destruct E as [E1 | E2].
      * apply IHre1 in E1. apply MUnionL. exact E1.
      * apply IHre2 in E2. apply MUnionR. exact E2.
    + simpl in E. apply MStar0.
  - apply ReflectF. intros H. induction re.
    + inversion H.
    + simpl in E. discriminate E.
    + inversion H.
    + simpl in E. inversion H. subst.
      apply app_eq_nil in H1. destruct H1 as [H1 H1']. subst.
      assert (andb_false_cases : forall a b, a && b = false -> a = false \/ b = false).
      { intros a b H'. destruct a, b; simpl in H'.
        - discriminate H'.
        - right. reflexivity.
        - left. reflexivity.
        - left. reflexivity. }
      apply andb_false_cases in E. clear andb_false_cases. destruct E as [E|E].
      * specialize (IHre1 E H3). destruct IHre1.
      * specialize (IHre2 E H4). destruct IHre2.
    + simpl in E.
      assert (orb_false_cases : forall a b, a || b = false -> a = false /\ b = false).
      { intros a b H'. destruct a, b; simpl in H'.
        - discriminate H'.
        - discriminate H'.
        - discriminate H'.
        - split; reflexivity. }
      apply orb_false_cases in E. clear orb_false_cases. destruct E as [E1 E2].
      inversion H; subst.
      * specialize (IHre1 E1 H2). destruct IHre1.
      * specialize (IHre2 E2 H1). destruct IHre2.
    + simpl in E. discriminate E.
Qed.
(** [] *)
...
Fixpoint derive (a : ascii) (re : reg_exp ascii) : reg_exp ascii :=
  ...
  | EmptySet => EmptySet
  | EmptyStr => EmptySet
  | Char a' => if Ascii.eqb a a' then EmptyStr else EmptySet
  | App re1 re2 =>
    if match_eps re1
